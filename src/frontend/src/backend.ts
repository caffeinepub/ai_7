...
import type { AIImage as _AIImage, ContactConfig as _ContactConfig, ExternalBlob as _ExternalBlob, ImageId as _ImageId, PaymentConfig as _PaymentConfig, UserProfile as _UserProfile, UserRole as _UserRole, WatermarkConfig as _WatermarkConfig, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addImage(arg0: ExternalBlob, arg1: Array<string>, arg2: string, arg3: bigint): Promise<ImageId> {
        if (this.processError) {
            try {
                const result = await this.actor.addImage(await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg0), arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteImage(arg0: ImageId): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getContactConfig(): Promise<ContactConfig> {
        if (this.processError) {
            try {
                ...
                return from_candid_ContactConfig_n14(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getImage(arg0: ImageId): Promise<AIImage> {
        if (this.processError) {
            try {
                const result = await this.actor.getImage(arg0);
                return from_candid_AIImage_n18(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getImageCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getImageCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getImagesByTag(arg0: TagId): Promise<Array<AIImage>> {
        if (this.processError) {
            try {
    ...
    async getImagesByTags(arg0: Array<string>): Promise<Array<AIImage>> {
        if (this.processError) {
            try {
                const result = await this.actor.getImagesByTags(arg0);
                return from_candid_vec_n20(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLatestImages(arg0: bigint): Promise<Array<AIImage>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLatestImages(arg0);
                return from_candid_vec_n20(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPaymentConfig(): Promise<PaymentConfig> {
        if (this.processError) {
            try {
                ...
                return from_candid_PaymentConfig_n21(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getWatermarkConfig(): Promise<WatermarkConfig> {
        if (this.processError) {
            try {
                const result = await this.actor.getWatermarkConfig();
                return from_candid_WatermarkConfig_n23(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async updateContactConfig(arg0: ContactConfig): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateContactConfig(await to_candid_ContactConfig_n25(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updatePaymentConfig(arg0: PaymentConfig): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updatePaymentConfig(await to_candid_PaymentConfig_n27(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateWatermarkConfig(arg0: WatermarkConfig): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateWatermarkConfig(await to_candid_WatermarkConfig_n29(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_AIImage_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _AIImage): Promise<AIImage> {
    return await from_candid_record_n19(_uploadFile, _downloadFile, value);
}
async function from_candid_ContactConfig_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ContactConfig): Promise<ContactConfig> {
...
async function from_candid_PaymentConfig_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PaymentConfig): Promise<PaymentConfig> {
...
async function from_candid_WatermarkConfig_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _WatermarkConfig): Promise<WatermarkConfig> {
...
async function from_candid_record_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    wechatBlob: [] | [_ExternalBlob];
    qqBlob: [] | [_ExternalBlob];
    xiaohongshuBlob: [] | [_ExternalBlob];
}): Promise<{
    wechatBlob?: ExternalBlob;
    qqBlob?: ExternalBlob;
    xiaohongshuBlob?: ExternalBlob;
    ...
    return {
        wechatBlob: record_opt_to_undefined(await from_candid_opt_n16(_uploadFile, _downloadFile, value.wechatBlob)),
        qqBlob: record_opt_to_undefined(await from_candid_opt_n16(_uploadFile, _downloadFile, value.qqBlob)),
        xiaohongshuBlob: record_opt_to_undefined(await from_candid_opt_n16(_uploadFile, _downloadFile, value.xiaohongshuBlob))
    };
}
...
async function from_candid_record_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        alipayBlob: record_opt_to_undefined(await from_candid_opt_n16(_uploadFile, _downloadFile, value.alipayBlob)),
        wechatBlob: record_opt_to_undefined(await from_candid_opt_n16(_uploadFile, _downloadFile, value.wechatBlob)),
...
async function from_candid_vec_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_AIImage>): Promise<Array<AIImage>> {
    return await Promise.all(value.map(async (x)=>await from_candid_AIImage_n18(_uploadFile, _downloadFile, x)));
}
async function to_candid_ContactConfig_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ContactConfig): Promise<_ContactConfig> {
...
async function to_candid_PaymentConfig_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: PaymentConfig): Promise<_PaymentConfig> {
...
async function to_candid_WatermarkConfig_n29(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: WatermarkConfig): Promise<_WatermarkConfig> {
...
async function to_candid_record_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        wechatBlob: value.wechatBlob ? candid_some(await to_candid_ExternalBlob_n8(_uploadFile, _downloadFile, value.wechatBlob)) : candid_none(),
        qqBlob: value.qqBlob ? candid_some(await to_candid_ExternalBlob_n8(_uploadFile, _downloadFile, value.qqBlob)) : candid_none(),
        xiaohongshuBlob: value.xiaohongshuBlob ? candid_some(await to_candid_ExternalBlob_n8(_uploadFile, _downloadFile, value.xiaohongshuBlob)) : candid_none()
    };
}
async function to_candid_record_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        alipayBlob: value.alipayBlob ? candid_some(await to_candid_ExternalBlob_n8(_uploadFile, _downloadFile, value.alipayBlob)) : candid_none(),
        wechatBlob: value.wechatBlob ? candid_some(await to_candid_ExternalBlob_n8(_uploadFile, _downloadFile, value.wechatBlob)) : candid_none(),
        priceText: value.priceText
    };
}
...
async function to_candid_record_n30(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        blob: value.blob ? candid_some(await to_candid_ExternalBlob_n8(_uploadFile, _downloadFile, value.blob)) : candid_none(),
        scale: value.scale,
        enabled: value.enabled,
        positionX: value.positionX,
        positionY: value.positionY
